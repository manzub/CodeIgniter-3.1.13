	...
	<section class="content">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<?php if (in_array('createReview', $user_permission)) : ?>
					<a href="<?php echo base_url('reviews/create') ?>" class="btn btn-primary">Create New Item</a>
					<br /> <br />
				<?php endif; ?>
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Manage Review Items</h3>
					</div>
					<div class="box-body">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form role="form" action="<?php echo base_url('reviews/delete') ?>" method="post" id="removeForm">
...
<script>
	...
	$(document).ready(function() {
		...
		manageTable = $('#manageTable').DataTable({
			'ajax': base_url + 'reviews/readReviewItems',
			'order': []
		});
