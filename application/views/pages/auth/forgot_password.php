      ...
      <div class="col-md-5">
        ...
        <div class="panel panel-default no-shadow">
          ...
          <div class="panel-body">
            <h1 class="page-title" style="font-size: 17px;font-weight:bold">Forgot Password</h1>
            <p style="font-size: 12px;">Forgotten the password to your account?</p>
            <p style="font-size: 12px;">Enter your email address below and a new password will be sent to your registered email to allow you access to your account again.</p>
            <span></span>
            <form action="<?php echo base_url('auth/forgot_password') ?>" method="post" class="">
