			...
			if ($this->form_validation->run() == TRUE) {
				...
				if ($update) {
					if ($approve_deny == 'approve') {
						...
						$x_2_remove = $transcribe_item['reward_points'];
						$this->model_users->logClaimedReward($completed_item['completed_by'], array('user_id' => $completed_item['completed_by'], 'transcribe_id' => $completed_item['transcribe_id'], 'reward_earned' => "-$x_2_remove", 'type' => 'mod_reward', 'streak' => '0'));
